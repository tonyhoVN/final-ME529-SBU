...
% End desire 
theta_end_d = [pi/3 pi/5 0 pi/2 pi/2 pi/2.5 0]';
...
% Find v_max, a_max
s_vmax = 0.5;
T_vmax = straightT_Trajectory(T_sd_start,T_sd_end,s_vmax,0,0);
...
s_amax = 0;
T_amax = straightT_Trajectory(T_sd_start,T_sd_end,s_amax,0,0);
...
[T_traj, p_dot_traj, p_ddot_traj] = straightT_Trajectory(T_sd_start,T_sd_end, s, s_dot, s_ddot);
